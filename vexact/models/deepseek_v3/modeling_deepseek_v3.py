...
def apply_deepseek_v3_patches() -> None:
    ...
    try:
        ...
        _original_veomni_attention_init = _veomni_dsv3.DeepseekV3Attention.__init__

        def _compat_veomni_attention_init(self, config, *args, **kwargs):
            _ensure_config_compat(config)
            _original_veomni_attention_init(self, config, *args, **kwargs)

        _veomni_dsv3.DeepseekV3Attention.__init__ = _compat_veomni_attention_init
