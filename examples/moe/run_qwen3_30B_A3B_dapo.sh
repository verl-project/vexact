...
test_path="${test_path:-/mnt/hdfs/test_path}"
...
profile_save_path=./verl_rollout_dapo.trace.json.gz
...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=$test_path/aime_2025.parquet \
    ...
    trainer.experiment_name="verl_grpo_qwen3moe_dapo_pp4" \
    trainer.val_before_train=False \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=5 \
    trainer.total_epochs=10 $@ 2>&1 | tee qwen3_moe_dapo.log
